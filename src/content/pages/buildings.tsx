      ...
      body: (
        <Prose>
          <p>
            ...
            is always for more than 90 days.
          </p>
          <DataTable
            ...
            note={
              <>
                ...
                for wood-frame apartments is not published.{" "}
                <Cite id="COV-RISK-2024" />
              </>
            }
          />
          ...
          <p>
            That is worth stopping on, because the usual line about wood is that
            it does well in an earthquake. That line is about houses. The
            engineering analysis behind the City’s 2026 action plan flags
            wood-frame apartment buildings separately, for walls that are
            neither stiff enough nor strong enough, for being likely
            uninhabitable after a design-level earthquake, and for the risk of
            the ground floor collapsing where it has been left open for
            tuck-under parking. <Cite id="COV-PLAN-2026" /> A house and an
            apartment block are not the same finding.
          </p>
          <p>
...

    {
      ...
      body: (
        <Prose>
          ...
          <p>
            Christchurch shows how this mechanism kills. Of the 42 deaths there
            from building failures other than the two tower collapses, 35 came
            from unreinforced masonry façades or walls falling, 26 of them onto
            people on the street or in vehicles. <Cite id="NZ-RC-V4" /> That is
            Christchurch and it stays Christchurch: it describes how people die
            under falling brick, and it sets no number for Vancouver.
          </p>
        </Prose>
      ),
    },
