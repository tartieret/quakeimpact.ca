...
nav: Life afterwards
hook: Thirteen essential systems recover on timelines set by their dependencies.
lede: Thirteen essential systems fail on different timelines after a major earthquake. Their recovery depends on roads, fuel, power and one another.
---
