...
disruption-cascadia: Help arrives later, with no US mutual aid [PEIRS]
...
The province's crustal planning scenario is a magnitude 7.0 beneath the Strait of
Georgia, and its damage is concentrated and local. [PEIRS] The impact area is the
...
From the Cascadia appendix of the province's earthquake response strategy, on a
rupture of the Cascadia subduction zone, the offshore fault that runs the length of
the coast:

> "a CSZ event would be devastating to B.C. as impacts would be felt over a very broad
...
| --- | --- |
| Alaska, Idaho, Oregon, Washington and Yukon | The Pacific Northwest Emergency Management Arrangement, established 1998 [AHP-2012] |
| The other provinces and territories | The Emergency Management Mutual Aid Agreement, a 2010 memorandum of the Canadian Council of Emergency Management Organizations [PEIRS] |
| Alberta | A memorandum of understanding dated 2007, and the Earthquake Response Plan for British Columbia, which Alberta holds [AHP-2012] [AB-ERPBC] |
| The Canadian Armed Forces | A Request for Assistance under Contingency Plan PANORAMA [PEIRS] |

> **Not published.** Alberta's government emergency plans page names the Earthquake
> Response Plan for British Columbia, whose objective is "to coordinate Alberta's
> assistance to British Columbia during a catastrophic earthquake", and describes it as
> "currently under review". Nine other plans on that page carry a download link and
> this one carries none. [AB-ERPBC] British Columbia's own strategy names the plan five
...
**Agree who checks on whom, before anything happens.** It takes a conversation now and
no equipment, and nobody can make the arrangement for you afterwards.

**Decide how long to hold out for, knowing the province's own documents disagree.**
The earthquake response strategy says up to two weeks. [PEIRS] The All-Hazard Plan
says a minimum of 72 hours. [AHP-2012] [Preparing](/prepare/) sets out what each
document says.

None of that replaces the response. It is what the province's own plan expects to be
happening while the response is on its way.
