...
about 20% of repairs are full breaks". [SCAWTHORN-2020] In three of the modelled
earthquakes the fire loss is driven "primarily due to lack of water for firefighting".
...
The Cascadia rupture is far offshore, so the ground motion it delivers in Metro
Vancouver is "relatively modest". The Georgia Strait earthquake has "an epicentre very
close to downtown Vancouver" and delivers "very strong" motion. The number of fires
follows the shaking on the spot, not the magnitude in the headline. [SCAWTHORN-2020]
...
False Creek in September 1995, the second at Coal Harbour
...
The system has not grown since. The last hydrants went into Kitsilano in 2003, and the
...
litres. "Vancouver and the Provincial Building By-laws lack a similar provision."
[SCAWTHORN-2020] The Vancouver Building By-law in force today still carries no such
requirement. [VBBL-2025] The study
...
will remain operational after a major event such as an earthquake." [COV-CAP-2730]

Fire Hall #12 in Kitsilano was chosen for seismic upgrade because it sits in "a
relatively large geographic area (west of Arbutus Street) where no fire hall meets
current seismic standards", and the same document records that
