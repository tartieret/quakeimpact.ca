...
| Safety and conflict | That neighbours are the threat. Most people help each other; theft, fights over supplies and violence at home still happen, and the worst documented case, Chile 2010, came with days without power, water and communications. Hatched in both columns, because nothing about it has a restoration time |
...
- **Safety and conflict is a system, hatched in both columns.** Decided 15 September 2026. It has no restoration time, so under the rubric neither cell can carry a band, and it has no dependency edges, because none is published. The title replaces "social disorder", which primes a fear the evidence does not support. See `research/social-disorder.md`.
