...
4. **The Metro Vancouver Regional Water Supply System Lifeline Study (2022).**
   Metro Vancouver publishes no FOI disclosure log, so a written request is the
   only route. The redacted items are named in `systems/water.md`.
5. **Knight Street ground improvement** — two ASCE papers, both obtainable through
   a normal library, now the highest-value unretrieved documents on the
   approach-embankment question. They replace the GeoManitoba paper, whose
   abstract is now in hand and whose four case studies turn out to be mostly
   outside Metro Vancouver.
6. **Port Mann.** Three published documents on this bridge's seismic design, none
   free: Goodyear (2017) *Structural Engineering International*, titled "Design
   Basis"; Lund & Mitchell (2017) *IABSE Reports*; and Leggett & Gérin. Until one
   is read in full, **no Port Mann number is published anywhere in this folder.**
...
Recheck before launch and on the stated cadence. Each names who or what would
change it.
...
| Burnaby B-SAFER strategy | Final due autumn 2026 | Dated |
| CRTC network resiliency policy | Record closed August 2026; no policy yet | On issue |
| GSC catalogue exclusions | The catalogue says losses are "not *currently* included" | Periodic |
| Sphere Handbook revision | Cycle opened March 2026, new edition targeted 2028 | 2028 |
| PreparedBC guidance | Its three pages currently contradict each other | Periodic |
| BC Hydro T&D resiliency assessment | Still "completing" | Periodic |
| Vancouver public URM inventory | Plan adopted, no publication date | Periodic |
...
| Cleveland Dam MCE seismic upgrade | Scheduled 2028–2034, not started | Annual |
| Metro Vancouver Dam Safety Program annual update | Tabled at Water Committee each year; carries the review conclusions | Annual |
| Provincial dam audits of Cleveland and Seymour Falls | Six years overdue on a five-year cycle | Periodic |
| City of Vancouver preparedness worksheet | Revised 8 September 2026 — the City's material is actively maintained, so the three-day figure is current, not stale | Periodic |
| Rice Lake dams | Dam Safety Review outstanding; carrying a live Caution flag | Periodic |
